...
"sparkstart")
    ...
    ssh hadoop100 "/opt/modules/spark-yarn/sbin/start-historyserver.sh"
;;
"sparkstop")
    echo $1
    echo "=============关闭hadoop集群============="
    echo "=============关闭spark-historyserver============="
    ssh hadoop100 "/opt/modules/spark-yarn/sbin/stop-historyserver.sh"
    echo "=============关闭yarn============="
    ssh hadoop101 "/opt/modules/hadoop-3.2.4/sbin/stop-yarn.sh"
    echo "=============关闭hdfs============="
    ssh hadoop100 "/opt/modules/hadoop-3.2.4/sbin/stop-dfs.sh"
